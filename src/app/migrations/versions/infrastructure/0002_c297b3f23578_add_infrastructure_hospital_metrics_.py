"""Add infrastructure hospital metrics table.

Revision ID: c297b3f23578
Revises: 36b82aeeff9c
Create Date: 2026-09-05 16:38:55.762518
...
revision: str = "c297b3f23578"
down_revision: str | Sequence[str] | None = "36b82aeeff9c"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parcel_id"],
            ["parcel.parcels.id"],
            name=op.f("fk_parcel_hospital_metrics_parcel_id_parcels"),
            ondelete="CASCADE",
        ),
