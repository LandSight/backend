"""School infrastructure metrics entity."""
...
class SchoolMetrics(InfrastructureMetrics):
    """Infrastructure metrics for the ``schools`` category.

    Maps to the ``parcel_school_metrics`` table.
    """
