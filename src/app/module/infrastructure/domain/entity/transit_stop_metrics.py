"""Transit stop infrastructure metrics entity."""
...
class TransitStopMetrics(InfrastructureMetrics):
    """Infrastructure metrics for the ``transit_stops`` category.

    Maps to the ``parcel_transit_stop_metrics`` table.
    """
