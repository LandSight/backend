"""SQLAlchemy ORM model for TransitStopMetrics."""
...
class TransitStopMetricsModel(TimestampedModel):
    """ORM model for the TransitStopMetrics entity.

    Maps to the ``infrastructure.parcel_transit_stop_metrics`` table.
    """

    __tablename__ = "parcel_transit_stop_metrics"
    ...
    count: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        comment="Number of transit stop objects within the buffer",
    )
...
__all__ = ("TransitStopMetricsModel",)
