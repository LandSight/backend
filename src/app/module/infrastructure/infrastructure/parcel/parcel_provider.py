...
from app.module.infrastructure.application.port import ParcelProvider
...
class ParcelProviderImpl(ParcelProvider):
    ...
    application-layer GeoJSON DTO used by the Infrastructure module.
    """
    ...
    async def get_parcel_polygon(self, parcel_id: UUID, user_id: UUID) -> GeoJSONPolygon:
        """See :class:`app.module.infrastructure.application.port.ParcelProvider.get_parcel_polygon`."""
