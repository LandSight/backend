...
from app.module.topography.application.port import MetricsPermissionService
...
class MetricsPermissionServiceImpl(MetricsPermissionService):
    ...
    composition root, so the Topography application layer stays decoupled
    ...
    async def user_can_view_parcel_metrics(self, user_id: UUID, parcel_id: UUID) -> bool:
        """See :class:`app.module.topography.application.port.MetricsPermissionService.user_can_view_parcel_metrics`."""
